...
- **Fase / Kelas**   : Fase D — VIII SMP
- **Materi Pokok**   : Pengolahan Bahan Serelia, Umbi-umbian dan Kacang-kacangan
- **Tujuan Belajar** : Mengidentifikasi berbagai jenis, karakteristik, dan kandungan gizi dari bahan pangan serealia, umbi-umbian, dan kacang-kacangan yang ada di wilayah setempat.
- **Nama Guru**      : Lina Windi Yatni, S.Pd
- **Nama Sekolah**   : SMP Negeri 2 Kedungpring
- **File Logo**      : LOGO SEKOLAH.JPEG
